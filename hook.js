  ...
  const STATS = [
    ...
    { match:"футболка", sub:"джерси, база", slot:"базовый, несъёмный",
      ...
      check:{skill:"Дерзость",act:"Расправить плечи",mod:1,diff:9,
        ok:["Плечи расправились. V-вырез превратился в декольте победителя.",
            "Ты стал на два сантиметра выше. Мир пересчитал тебя заново."],
        no:["Плечи вернулись на место через полторы секунды. Спина помнит опенспейс.",
            "Расправил. Хрустнуло. Теперь все в комнате знают, сколько тебе лет."]}},
  ];
