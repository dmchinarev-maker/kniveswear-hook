...
(() => {
  ...
  const STATS = [
    ...
    { match:"брюки из шерсти",
      ...
      check:{skill:"Савуар-фер",act:"Сесть на корточки, не потеряв лица",mod:2,diff:9,
    ...
    { match:"луи",
      bars:{"Резист холоду":64,"Резист жаре":36,"Савуар-фер":85,"Прочность":70,"Дерзость":62},
      pass:[["Крой","версальский, адаптирован под метро"],["Испытано","двери, лестницы, реверансы"]],
      check:{skill:"Савуар-фер",act:"Сказать «после вас»",mod:3,diff:9,
